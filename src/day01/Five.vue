...
const studentAll = watch(student,(newValue,oldValue)=>{
  console.log(`学生的对象内容发生了变化，新值newValue是${JSON.stringify(newValue)},旧值oldValue是  ${JSON.stringify(oldValue)}`)
},{ deep: true})
</script>
